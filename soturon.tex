...
\input{svm} % intro.tex を読み込む。
\clearpage
\input{abc} % intro.tex を読み込む。
\clearpage
\input{origin} % intro.tex を読み込む。
\clearpage
\input{method} % intro.tex を読み込む。
\clearpage
\input{result} % intro.tex を読み込む。
\clearpage
\input{kousatu.tex}
\clearpage
\input{end} % intro.tex を読み込む。
\clearpage
...
\bibitem{abc}Karaboga, Dervis. “An idea based on honey bee swarm for numerical optimization”，
